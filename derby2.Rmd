...
- Fishing apps are very common
- Management agencies are stressed for money and time
- constantly trying to figure out how to leverage this cheap data source for informaiton on their fisheries
- work to date has tried to correlate fishing information from apps, but all is ad-hoc
- how can we design a sampling protocol that uses anglers to collect information for us?
- DERBIES!!
- others?
...
- Integrate into stock assessment - combine with fishing effort estimates
- 
